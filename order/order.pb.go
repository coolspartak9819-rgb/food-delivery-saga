...
type CreateOrderRequest struct {
	...
	// Мы можем передавать сложные данные как JSON-строку для гибкости.
...
func (x *CreateOrderRequest) GetItemsJson() string {
	if x != nil {
		return x.ItemsJson
	}
	return ""
...
type CreateOrderResponse struct {
	...
	Status string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // Например, "ORDER_CREATED"
}
...
type CancelOrderResponse struct {
	...
	Status string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // Например, "ORDER_CANCELLED"
}
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x64, 0x0a, 0x12, 0x43, 0x72,
	...
	0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x5f, 0x6a, 0x73, 0x6f, 0x6e, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x4a, 0x73, 0x6f, 0x6e,
	0x22, 0x2d, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	0x42, 0x0c, 0x5a, 0x0a, 0x73, 0x61, 0x67, 0x61, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x06,
